...
class Soldier_Blue : public GameEngineActor
{
public:
	...
	// delete Function
	Soldier_Blue(const Soldier_Blue& _Other) = delete;
	Soldier_Blue(Soldier_Blue&& _Other) noexcept = delete;
	Soldier_Blue& operator=(const Soldier_Blue& _Other) = delete;
	Soldier_Blue& operator=(Soldier_Blue&& _Other) noexcept = delete;
...
private:
	...
	Soldier_BlueState StateValue = Soldier_BlueState::MOVE;
	...
	void ChangeState(Soldier_BlueState _State);
